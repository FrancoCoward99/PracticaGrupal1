...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container mt-5 flex-grow-1">
        ...
        <a href="agregaTarea.php" class="btn btn-success mb-4">Nueva Tarea</a>
    ...
    ?>
            <div class="col-md-4 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <img src="<?= htmlspecialchars($tarea['urlImagen']) ?>" class="card-img-top" alt="Imagen de tarea"
                        style="height: 200px; object-fit: cover;">
                    <?php endif; ?>
                    <div class="card-body">
                        <h5 class="card-title" title="<?= htmlspecialchars($tarea['tarea']) ?>">
                        ...
                        <p class="text-muted mb-1 fw-bold">Estado:
                            <?= estadoBadge($tarea['estadoID']) ?>
                        </p>

                        <p class="text-muted mb-1 fw-bold">
                            Creado:
                            <?= htmlspecialchars($tarea['fechaCreacion']) ?>
                        </p>
                        <p class="text-muted fw-bold">
                            Actualizado:
                            <?= htmlspecialchars($tarea['fechaActualizacion']) ?>
                        </p>
                    </div>
                    <div class="card-footer text-end">
                        <a href="editarTarea.php?id=<?= $tarea['id'] ?>" class="btn btn-sm btn-primary">Editar</a>
                        <a href="eliminarTarea.php?id=<?= $tarea['id'] ?>" class="btn btn-sm btn-danger"
